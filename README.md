...
*Note*: Upper head and side blurred for anonymity. The dots in the left picture indicate the 3D-coordinates extracted with VideoPose3D. On the right side, the extracted body points are visualized in 3D space.
